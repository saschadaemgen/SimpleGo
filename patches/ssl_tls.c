                                  ...
                                  const unsigned char *end, size_t *out_len)
{
    ...
    *out_len = 0;
    ...
    /* SIMPLEX PATCH: Add Ed25519 and Ed448 for SimpleX server compatibility */
    MBEDTLS_SSL_CHK_BUF_PTR(p, end, 4);
    MBEDTLS_PUT_UINT16_BE(0x0807, p, 0);  /* ed25519 */
    p += 2;
    MBEDTLS_PUT_UINT16_BE(0x0808, p, 0);  /* ed448 */
    p += 2;
    MBEDTLS_SSL_DEBUG_MSG(3, ("sent signature scheme [0x0807] ed25519 (PATCHED)"));
    MBEDTLS_SSL_DEBUG_MSG(3, ("sent signature scheme [0x0808] ed448 (PATCHED)"));
